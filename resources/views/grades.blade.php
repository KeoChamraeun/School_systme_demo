        ...
        <div id="alert-2" class="flex p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
            <div class="inline-flex flex-col">
                ...
                <div class="inline-flex p-1">
                    <svg aria-hidden="true" class="flex-shrink-0 w-5 h-5 mx-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{route('grade.store')}}" method="post">
                    ...
                    <div>
                        <label for="gradename_ar" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Grade name in Khmer</label>
